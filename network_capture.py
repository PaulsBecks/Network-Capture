...
class network_capture(object):
    ...
    def __init__(self, *args):
        ...
        # Set the filtered pcap file name
    ...
    #
    # Get a filename to set for the pcap filtered file.
            ...
            while True:
                ...
                if captured_line is not None and captured_line != b'':
                    ...
                    if keyword_filtering:
                        if all(key in captured_line for key in self.keywords):
                            print("** Keyword found. Writing to log **")
                            # Removing this until this works
                            x, y = [1,2]
                            #time, netProt, src, to, dst, transProt, x, length  = captured_line.split(" ")
                            print(captured_line.split(" "))
                            line_count += 1
                    else:
                        line_count += 1
